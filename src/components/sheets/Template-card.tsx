...
const TemplateCard = ({
  ...
  return (
    <button className="w-full group relative p-4 rounded-xl border border-border cursor-pointer bg-card text-left transition-all duration-300 hover:shadow-elevated hover:border-primary/30 hover:-translate-y-1 animate-slide-up">
      <div
