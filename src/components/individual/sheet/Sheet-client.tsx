                ...
                {filtered
                  ...
                  .map((f) => (
                    <button
                      ...
                      className={`w-full text-left px-2.5 py-1.5 text-[11px] font-mono border-b transition-colors ${selected?.name === f.name ? "bg-primary/10 text-primary font-semibold" : "hover:bg-gray-50 text-gray-700"}`}
                    >
                      {f.name}
                    </button>
                  ))}
...
function SelectOptionsSetupDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-sm sheet-dialog">
        <DialogHeader>
          <DialogTitle className="text-sm font-semibold flex items-center gap-2">
        ...
        <div className="space-y-3 py-1">
          <textarea
            autoFocus
            className="w-full h-24 px-3 py-2 text-xs rounded-md border border-gray-200 bg-gray-50 outline-none focus:border-primary focus:bg-white resize-none font-mono"
        ...
        <DialogFooter className="gap-2 pt-1 border-t">
          <button
            onClick={onClose}
            className="text-xs px-3 py-1.5 rounded border border-gray-200 hover:bg-gray-50 transition-colors"
          >
