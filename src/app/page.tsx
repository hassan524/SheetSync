    ...
    <div className="bg-white">
      ...
      <section id="pricing" className="py-24 sm:py-32 bg-white">
        <div className="max-w-5xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="rounded-3xl border border-gray-200 bg-gray-50 p-6 sm:p-10 mb-8">
      ...
      <section className="py-24 sm:py-32 bg-gray-50 border-y border-gray-100">
        <div className="max-w-6xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {featureTiles.map(({ icon: Icon, title, desc, color }) => (
              <div
                key={title}
                className="group rounded-2xl border border-gray-100 bg-white hover:border-gray-200 hover:shadow-md transition-all duration-200 p-5 flex gap-4 items-start"
              >
      ...
      <section className="py-24 sm:py-32 bg-white">
        <div className="max-w-4xl mx-auto px-5 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-primary via-green-600 to-teal-700 text-white px-8 sm:px-14 py-14 sm:py-16 rounded-3xl text-center flex flex-col items-center gap-6 shadow-2xl shadow-primary/20">
      ...
      <section id="contact" className="py-24 sm:py-32 bg-gray-50 border-t border-gray-100">
        <div className="max-w-3xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm px-4 sm:px-6 py-2">
